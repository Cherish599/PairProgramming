...
namespace StuDataBase
{
    public class StudentDataset
    {
        ...
        public static List<Student> getAll()
        {
            ...
            Student stu33 = new Student("027", "陈林", "男");
            studengList.Add(stu33);
            Student stu34 = new Student("028", "曾正男", "男");
            studengList.Add(stu34);

            Student stu35 = new Student("029", "江天宇", "男");
            studengList.Add(stu35);
            Student stu36 = new Student("036", "魏恩博", "男");
            studengList.Add(stu36);

            Student stu37 = new Student("031", "邹扬锋", "男");
            studengList.Add(stu37);
            Student stu38 = new Student("032", "曾琅", "男");
            studengList.Add(stu38);

            Student stu39 = new Student("032", "周成杰", "男");
            studengList.Add(stu39);
            Student stu40 = new Student("032", "马驰", "男");
            studengList.Add(stu40);

            Student stu41 = new Student("032", "宋树钱", "男");
            studengList.Add(stu41);
            Student stu42 = new Student("032", "马驰", "男");
            studengList.Add(stu42);
            Student stu43 = new Student("032", "任星辰", "男");
            studengList.Add(stu43);

            Student stu44 = new Student("032", "严一笑", "男");
            studengList.Add(stu44);
            Student stu45 = new Student("032", "孙颖", "女");
            studengList.Add(stu45);
            Student stu46 = new Student("032", "吴明益", "女");
            studengList.Add(stu46);
            Student stu47 = new Student("032", "黄耀萱", "女");
            studengList.Add(stu47);
            Student stu48 = new Student("032", "王静宜", "女");
            studengList.Add(stu48);
            Student stu49 = new Student("032", "蔡玉蓝", "女");
            studengList.Add(stu49);

            Student stu50 = new Student("032", "姜仪", "女");
            studengList.Add(stu50);

            Student stu51 = new Student("032", "郑雪", "女");
            studengList.Add(stu51);
            Student stu52 = new Student("032", "刘俊", "女");
            studengList.Add(stu52);
            Student stu53 = new Student("032", "何玉姣", "女");
            studengList.Add(stu53);
            Student stu54 = new Student("032", "匡小娟", "女");
            studengList.Add(stu54);
            Student stu55 = new Student("032", "王春兰", "女");
            studengList.Add(stu55);
            Student stu56 = new Student("032", "顾毓", "女");
            studengList.Add(stu56);
            Student stu57 = new Student("032", "师志杰", "男");
            studengList.Add(stu57);
            Student stu58 = new Student("032", "许佳文", "男");
            studengList.Add(stu58);
            Student stu59 = new Student("032", "雷安勇", "男");
            studengList.Add(stu59);

            Student stu60 = new Student("032", "张伟", "男");
            studengList.Add(stu60);


            Student stu61 = new Student("032", "袁志杰", "男");
            studengList.Add(stu61);
            Student stu62 = new Student("032", "何全江", "男");
            studengList.Add(stu62);
            Student stu63 = new Student("032", "舒鹏飞", "男");
            studengList.Add(stu63);
            Student stu64 = new Student("032", "何辉", "男");
            studengList.Add(stu64);
            Student stu65 = new Student("032", "李全喜", "男");
            studengList.Add(stu65);
            Student stu66 = new Student("032", "谢凯宇", "男");
            studengList.Add(stu66);
            Student stu67 = new Student("032", "黄本巍", "男");
            studengList.Add(stu67);
            Student stu68 = new Student("032", "罗俊杰", "男");
            studengList.Add(stu68);
            Student stu69 = new Student("032", "何宸锐", "男");
            studengList.Add(stu69);
            Student stu70 = new Student("032", "付昶宇", "男");
            studengList.Add(stu70);
            Student stu71 = new Student("032", "傅伟鑫", "男");
            studengList.Add(stu71);

            Student stu72 = new Student("032", "王云飞", "男");
            studengList.Add(stu72);

            Student stu73 = new Student("032", "李元港", "男");
            studengList.Add(stu73);

            Student stu74 = new Student("032", "赵荣泽", "男");
            studengList.Add(stu74);

            Student stu75 = new Student("032", "吴郑浩", "男");
            studengList.Add(stu75);

            Student stu76 = new Student("032", "何继武", "男");
            studengList.Add(stu76);

            Student stu77 = new Student("032", "郑博", "男");
            studengList.Add(stu77);

            Student stu78 = new Student("032", "王万成", "男");
            studengList.Add(stu78);

            Student stu79 = new Student("032", "陈杰", "男");
            studengList.Add(stu79);

            Student stu80 = new Student("032", "胡志伟", "男");
            studengList.Add(stu80);

            Student stu81 = new Student("032", "涂林", "男");
            studengList.Add(stu81);
            Student stu82 = new Student("032", "孟诚成", "男");
            studengList.Add(stu82);
            Student stu83 = new Student("032", "廖志丹", "男");
            studengList.Add(stu83);
            Student stu84 = new Student("032", "杨也", "女");
