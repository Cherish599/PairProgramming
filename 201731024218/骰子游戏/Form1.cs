...
namespace 骰子游戏
{
    public partial class Form1 : Form
    {
        ...
        {
            axWindowsMediaPlayer1.URL = basePath + @"音乐\卢冠廷 - 賭神.mp3";
        }
        ...
        private void BtnStop_Click(object sender, EventArgs e)
        {
            ...
            if (result==DaOrXiao)
            {
                axWindowsMediaPlayer1.URL =basePath+ @"音乐\Ozo - Epic Sax Guy.mp3";
                Bitmap bm = new Bitmap(basePath+@"图片\win.gif");
                pictureBox2.Image = bm;
            }
            else
            {
                axWindowsMediaPlayer1.URL = basePath+@"音乐\阿炳 - 二泉映月.mp3";
                Bitmap bm = new Bitmap(basePath+@"图片\lose.gif");
                pictureBox2.Image = bm;
            }
        }
    }
