...
namespace WinformControlUse
{
    public partial class FrmStudent : Form
    {
        ...
        {
            timerCallName.Stop();
            DialogResult result = MessageBox.Show("该同学到了吗？","Confirm Message",MessageBoxButtons.YesNo,MessageBoxIcon.Question);
            if(result == DialogResult.Yes)
            {
                MessageBox.Show("Good Student!");
            }
            else
            {
                MessageBox.Show("记缺勤一次!");
            }
        }
